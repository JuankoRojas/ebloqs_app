...
class PaymentTransferenciaScreen extends StatefulWidget {
  static const String routeName = 'PaymentTransferenciaScreen';
  final String? cantidadTransferencia;
  final Map invest;
  final String eblValue;
  const PaymentTransferenciaScreen({
    Key? key,
    this.cantidadTransferencia,
    required this.invest,
    required this.eblValue,
  }) : super(key: key);

  @override
  State<PaymentTransferenciaScreen> createState() =>
      _PaymentTransferenciaScreenState();
}

class _PaymentTransferenciaScreenState
    extends State<PaymentTransferenciaScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.cantidadTransferencia!.isNotEmpty &&
      ...
      cantidad = double.parse(
          NumberFormat().parse(widget.cantidadTransferencia!).toString());
      recibes = cantidad;
      print(cantidad);
      print(recibes);
    }
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) => PaymentCongratsScreen(
                                      ...
                                      cardNumber:
                                          Provider.of<AccountInfoProvider>(
                                                  context,
                                                  listen: false)
                                              .numeroCuenta
                                              .toString(),
                                      usdValue: quantityController.text,
