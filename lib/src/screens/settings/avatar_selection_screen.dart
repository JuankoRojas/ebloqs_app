        ...
        child: SingleChildScrollView(
          child: Column(
              ...
              children: [
                ...
                Padding(
                  padding:
                      EdgeInsets.only(top: size.height * 0.0332512315270936),
                  child: Center(
                    child: Container(
                      width: 78,
                      height: 78,
                ...
                Padding(
                  padding:
                      EdgeInsets.only(top: size.height * 0.0369458128078818),
                  child: Row(
                    ...
                    children: [
                      GestureDetector(
                        ...
                        onTap: () async {
                          ...
                          final response = await AuthUserService().updateAvatar(
                              avatarName: 'assets/uavatares/1.svg',
                      ...
                      GestureDetector(
                        ...
                        onTap: () async {
                          ...
                          final response = await AuthUserService().updateAvatar(
                              avatarName: 'assets/uavatares/2.svg',
                              accesstoken: Preferences.token!);
                          print(response);
                        },
                      ),
                      GestureDetector(
                        ...
                        onTap: () async {
                          ...
                          final response = await AuthUserService().updateAvatar(
                              avatarName: 'assets/uavatares/3.svg',
                              accesstoken: Preferences.token!);
                          print(response);
                        },
                      ),
                      GestureDetector(
                        ...
                        onTap: () async {
                          ...
                          final response = await AuthUserService().updateAvatar(
                              avatarName: 'assets/uavatares/4.svg',
                              accesstoken: Preferences.token!);
                          print(response);
                        },
                      ),
                    ...
                    children: [
                      GestureDetector(
                        ...
                        onTap: () async {
                          ...
                          final response = await AuthUserService().updateAvatar(
                              avatarName: 'assets/avatares/mascota/pet-1.svg',
                              accesstoken: Preferences.token!);
                          print(response);
                        },
                      ),
                      GestureDetector(
                        ...
                        onTap: () async {
                          ...
                          final response = await AuthUserService().updateAvatar(
                              avatarName: 'assets/avatares/mascota/pet-2.svg',
                              accesstoken: Preferences.token!);
                          print(response);
                        },
                      ),
                      GestureDetector(
                        ...
                        onTap: () async {
                          ...
                          final response = await AuthUserService().updateAvatar(
                              avatarName: 'assets/avatares/mascota/pet-3.svg',
                              accesstoken: Preferences.token!);
                          print(response);
                        },
                      ),
                      GestureDetector(
                        ...
                        onTap: () async {
                          ...
                          final response = await AuthUserService().updateAvatar(
                              avatarName: 'assets/avatares/mascota/pet-4.svg',
                              accesstoken: Preferences.token!);
                          print(response);
                        },
                      ),
